...
import com.lsk.springbootmall.rowmapper.OrderItemRowMapper;
import com.lsk.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public void createOrderItems(Integer orderId, List<Orderitem> orderitemList) {
        ...
        for (int i = 0; i < orderitemList.size(); i++) {
            ...
            parameterSources[i].addValue("productid",orderitem.getProduct());
